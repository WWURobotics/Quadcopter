...
int main()
{
    ...
    MotorImplementation motor1(PinName::p21, 20000, 0.002, 8000/20000.0, (1.0 - 8000/20000.0) / 20000.0, 0, 7500/20000.0);
    MotorImplementation motor2(PinName::LED1, 20000, 0.002, 8000/20000.0, (1.0 - 8000/20000.0) / 20000.0, 0, 7500/20000.0);
    MotorImplementation motor3(PinName::LED2, 20000, 0.002, 0, 1 / 20000.0, 0);
    AnalogInput ain(PinName::p20, 0, 20000);
    ...
    scheduler.add(ain);
    scheduler.add(make_shared<FnRunnable>([&ain, &outStream, &motor1, &motor2, &motor3](){outStream << ain; *motor1 = ain.read(); *motor2 = ain.read(); *motor3 = ain.read();}));
